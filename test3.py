...
async def run():
    """1m kalk, GPS ile ölçerek 1m ileri git, in."""
    drone = System()
    ...
    # İleri hareketi başlat
    await drone.offboard.set_velocity_body(VelocityBodyYawspeed(1.0, 0.0, 0.0, 0.0)) # 1 m/s hızla ileri
