...
async def run():
    """1m kalk, GPS ile ölçerek 1m sağa git, in."""
    drone = System()
    ...
    # Sağa hareketi başlat
    await drone.offboard.set_velocity_body(VelocityBodyYawspeed(0.0, 1.0, 0.0, 0.0)) # 1 m/s hızla sağa
